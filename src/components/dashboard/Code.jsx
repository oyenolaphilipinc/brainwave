      ...
      <div className="flex-grow">
        ...
        <div className="mt-10">
            <div className="flex ml-3">
                <div className="mb-12">
                    <Code className="h-15 w-20 mr-2 md:mr-0 text-green-700 border px-3 py-1 rounded-md border-[#0e0d15]"/>
                    </div>
                    <div>
                    <h1 className="flex text-3xl ml-1 md:ml-2 md:text-3xl">Code Generation</h1>
                    <p className="text-center text-lg md:text-sm md:ml-2">Generate code using descriptive text.</p>
                </div>
            </div>
            <div>
                <div className="border w-11/12 px-2 mx-auto py-3 border-gray-700 rounded-md md:flex">
                    <input type="text" placeholder="Simple toggle button using react hooks." className="w-full outline-none border-r-none pl-2 md:pl-4 mb-3 bg-[#0e0d15]"/><br/>
